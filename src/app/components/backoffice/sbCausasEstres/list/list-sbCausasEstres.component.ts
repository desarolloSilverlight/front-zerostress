...
@Component({
  selector: 'app-list-sbCausasEstres',
  templateUrl: './list-sbCausasEstres.component.html',
  styleUrls: ['./list-sbCausasEstres.component.css']
})
export class ListSbCausasEstresComponent implements OnInit {
  displayedColumns: string[] = ['id', 'tpCausa', 'tpCatCausa', 'descripcion', ' '];
  ...
  constructor(private sbCausasEstresService: SbCausasEstresService, private actRoute: ActivatedRoute) {
  ...
  singularFilter(event: Event) {
    ...
    const t: SbCausasEstres = new SbCausasEstres();
