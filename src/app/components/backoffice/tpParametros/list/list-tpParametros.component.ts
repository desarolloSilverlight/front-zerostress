...
@Component({
  ...
  templateUrl: './list-tpParametros.component.html',
  styleUrls: ['./list-tpParametros.component.css']
})
export class ListTpParametrosComponent implements OnInit {
  ...
  constructor(private tpParametros: TpParametroService) {
  }

  ngOnInit(): void {
    this.tpParametros.list(new TpParametro()).toPromise().then(resp => {
